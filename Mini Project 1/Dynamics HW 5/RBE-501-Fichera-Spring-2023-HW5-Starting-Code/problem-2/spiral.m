...
for jj = 1 : nPts - 1
    ...
    jointVel_actual(:,1) = jointVel_prescribed(:,1); %%change
    ...
    for ii = 1 : size(t,2) - 1
        ...
        params_rne.Ftip = ones(6,1); % end effector wrench
        ...
        params_fdyn.Ftip = ones(6,1); % end effector wrench
...
%% Animate the robot
title('Inverse Dynamics Control');
% robot.plot(jointPos_acc(:,1:100:end)')
robot.plot(jointPos_acc(:,1:100:end)','trail',{'r', 'LineWidth', 2}, 'movie', 'RBE-501-2023-HW5-point2pointpb2.mp4');
fprintf('Done.\n');
